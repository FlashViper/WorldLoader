...
func _get_recognized_extensions() -> PackedStringArray:
	print("Polled for file extension")
	return PackedStringArray(["world", "wrld"])

func _get_save_extension() -> String:
	print("Polled for save extension")
	return "res"

func _get_resource_type() -> String:
	print("Polled for resource type")
	return "Resource"
...
func _import(source_file, save_path, options, platform_variants, gen_files) -> int:
	print("Was asked to import file %s" % source_file)
	...
	print("Imported file succesfully")
